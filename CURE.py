...
def Cure(path,threshold,k):
    ...
    #represent_points = spark.sparkContext.broadcast(represent_points)
    #represent_points.value
    ...
    prediction_df = df.withColumn("prediction", assign_points(represent_points)(F.col("0"), F.col("1"))).show()
